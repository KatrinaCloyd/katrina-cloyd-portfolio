    ...
    return (
        <div className={styles.iconWrapper}>
            <a href="mailto: katrina.cloyd@yahoo.com" target='_blank'>
                <img
                    onMouseEnter={() => fadeInNote('Click to email me at katrina.cloyd@yahoo.com')}
            ...
            <a href='https://twitter.com/KatMariee_PDX' target='_blank'>
                <img
                    onMouseEnter={() => fadeInNote('Click to visit my Twitter <br /> (I\'m new here so not much)')}
                    onMouseLeave={() => fadeOutNote('')}
                    className={styles.icon}
                    src='/Twitter.svg'
                    alt='twitter' />
            ...
            <a href='https://www.instagram.com/katmarieepdx/' target='_blank' >
                <img
                    onMouseEnter={() => fadeInNote('Click to visit my Instagram <br /> (mostly family stuff and baking)')}
                    onMouseLeave={() => fadeOutNote('')}
                    className={styles.icon}
                    src='/ig2.svg'
                    alt='instagram' />
            </a>
            <p className={hoverOrNot}
